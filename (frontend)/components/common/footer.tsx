    ...
    <footer className="w-full py-12 bg-primary text-primary-foreground">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="space-y-4 col-span-2">
            <div className="flex items-center space-x-2">
              <FlowerLotusIcon className="h-8 w-8 text-primary-foreground" />
              <span className="font-bold text-xl">Không Gian Văn Hoá HCM</span>
            </div>
            <p className="text-primary-foreground">
              Không Gian Văn Hoá HCM là một dự án văn hoá của TP.HCM
            </p>
          </div>
          <div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20 text-center text-primary-foreground">
          <p>
            &copy; {new Date().getFullYear()} HCMC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
